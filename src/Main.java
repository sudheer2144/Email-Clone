...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        Email email = new Email("sudheer@gmail.com");
        System.out.println(email.getEmailId());
        System.out.println("Default passowrd: "+email.getPassword());
        email.changePassword("sudheer@2144", "kj@sd");
        email.changePassword("sudheer@214", "dfhdiuskj");
        email.changePassword("sudheer@2144", "Suba@9836");

        System.out.println(email.getEmailId());
        System.out.println(email.getPassword());

        Gmail gmail = new Gmail("sudheer@gmail.com", 3);

        gmail.receiveMail(new SimpleDateFormat("dd/MM/yyyy").parse("21/12/2022"), "suba", "Assignment Completed?");
        gmail.receiveMail(new SimpleDateFormat("dd/MM/yyyy").parse("22/12/2022"), "sudheer", "We are running out of time.");
        gmail.receiveMail(new SimpleDateFormat("dd/MM/yyyy").parse("22/12/2022"), "lakshmi", "Assignment to be uploaded on database.");
        gmail.receiveMail(new SimpleDateFormat("dd/MM/yyyy").parse("23/12/2022"), "yes", "Everything looks good.");
